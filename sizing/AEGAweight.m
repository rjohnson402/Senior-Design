...
%% ======================= 1. AIRCRAFT LEVEL =============================
DG     = pick(ac,'DG',     2200);   % design gross weight (A guess that a sizing tool would converge on)
...
%% ======================= 5. FLIGHT CONDITION ===========================
rho_c    = pick(ac,'rho_c',    0.002048);  % density at cruise
...
HHT    = pick(ac,'HHT',    1);      % 0 body-mounted tail, 1 T-tail (+20% fin)
